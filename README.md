# genpark-ai-code-review-sandbox-execution-verifier-skill
...
> **GenPark AI Agent Skill** -- AI code reviewer that sandboxes & executes PR diffs before merge (Ito style)
